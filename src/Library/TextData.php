<?php 
namespace EsperoSoft\Library;

class TextData{
    private $text;
    private $first = true;
    private $words = array(
        'mudey', 'ipsum', 'dolor', 'sit', 'amet', 'consectetur', 'adipiscing', 'elit',
        'a', 'ac', 'accumsan', 'ad', 'aenean', 'aliquam', 'aliquet', 'ante',
        'aptent', 'arcu', 'at', 'auctor', 'augue', 'bibendum', 'blandit',
        'class', 'commodo', 'espero', 'congue', 'consequat', 'conubia',
        ...
        'enim', 'erat', 'eros', 'formation', 'et', 'etiam', 'eu', 'euismod', 'ex',
